...
## 8. Bu Repo'daki Aktif Skill Entegrasyonu

Bu repoda skill-first yaklaşımı ile erişilebilirlik kontrolü merkezileştirilmiştir.

- Skill konumu: [../.github/skills/wcag-2-2-mobile-aa/SKILL.md](../.github/skills/wcag-2-2-mobile-aa/SKILL.md)
- Checklist: [../.github/skills/wcag-2-2-mobile-aa/checklist.md](../.github/skills/wcag-2-2-mobile-aa/checklist.md)
- Agent eşlemesi: [../.github/skills/wcag-2-2-mobile-aa/agent-mapping.md](../.github/skills/wcag-2-2-mobile-aa/agent-mapping.md)
- Test rehberi: [../.github/skills/wcag-2-2-mobile-aa/test-guidance.md](../.github/skills/wcag-2-2-mobile-aa/test-guidance.md)

### 8.1 Kapsam ve Politika

- Standart: **WCAG 2.2 AA (mobile-adapted)**
- Kapsam: **Sadece yeni/değişen UI**
- Merge yaklaşımı: **Soft gate + zorunlu açıklama ve takip aksiyonu**

### 8.2 Agent Kullanımı

- **Architecture Planning**: Feature planına erişilebilirlik acceptance criteria ekler
- **React Native Developer**: UI implementasyonunda skill checklist maddelerini uygular
- **Code Reviewer**: Bulguları skill checklist'e göre sınıflandırır
- **Test Writer**: Otomatik/manüel a11y doğrulama ayrımını raporlar
- **Merge Coordinator**: Accessibility Soft Gate çıktısını zorunlu uygular
